...
describe EventsController do
  ...
  let(:valid_attributes) { { "when" => "2013-09-13 13:56:56" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event as @event" do
        ...
        post :create, {:event => { "when" => "invalid value" }}, valid_session
        assigns(:event).should be_a_new(Event)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update).with({ "when" => "2013-09-13 13:56:56" })
        put :update, {:id => event.to_param, :event => { "when" => "2013-09-13 13:56:56" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event as @event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Event.any_instance.stub(:save).and_return(false)
        put :update, {:id => event.to_param, :event => { "when" => "invalid value" }}, valid_session
        assigns(:event).should eq(event)
      end
